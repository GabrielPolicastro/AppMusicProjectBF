...
//  AppMusicProject
//
//  Created by Gabriel Policastro on 30/01/23.
//
...
//        img.image = UIImage(named: "list4")
    ...
    lazy var marqueeLabel: MarqueeLabel = {
        ...
        l.text = "Aqui será o nome da música onde terá o Scroll"
        l.textColor = .white.withAlphaComponent(0.8)
        l.font = UIFont(name: "Avenir-Heavy", size: 18)
        l.type = .continuous // tipo de carregamento, igual pra direita, igual o spotfy
        l.animationCurve = .linear // curva de animacao
        l.fadeLength = 10.0  // propriedades que tratam o espacamento
    ...
    lazy var pausePlayBtn: UIImageView = {
        let img = UIImageView()
        img.translatesAutoresizingMaskIntoConstraints = false
        img.image = UIImage(named: "pause")?.withRenderingMode(.alwaysTemplate)//para utilizar o tint color, sem o withRenderingMode no alwaysTemplate, nao conseguirei utilizar o tintColor
    ...
    private func setupViews(){  // adicionados os 4 elementos
