...
//  AppMusicProject
//
//  Created by Gabriel Policastro on 10/01/23.
//

import UIKit

class CardActionView: UIView {  // Parte onde estao as opcoes de baixar, dar play, curtir e etc
    ...
    lazy var downloadBtn:UIButton = {
        ...
        btn.backgroundColor = .white.withAlphaComponent(0.3) // cor do botao fraquinha
        btn.layer.cornerRadius = 22.5
        btn.setBackgroundImage(UIImage(named: "download")?.withRenderingMode(.alwaysTemplate), for: .normal)
        btn.tintColor = .white //// always template quebra protocolos de segurança da imagem e permite manipular a imagem
