...
class DetailViewControllerScreen: UIView {
    ...
    lazy var scrollView: UIScrollView = {
        ...
        view.autoresizingMask = .flexibleHeight // altura flexivel, se auto ajusta
        view.bounces = false
    ...
    // retirar override quando o metodo for novo, ou seja
    // dispatchqueue usado quando se usa stackview, pois a tela esta sendo forcada e o layout esta fazendo uma adaptacao, quando se clica na tela, a tableView eh forcada a crescer
    ...
    private func setupConstraints(){
        ...
        self.scrollView.pin(to: self) // necessita ficar sob todas as nossas posicoes
        ...
        NSLayoutConstraint.activate([
            ...
            self.navBar.heightAnchor.constraint(equalToConstant: ((topPadding ?? 0.0) + 80)), //distancia do topo mais 80 referente ao card
...
//            self.playerView.bottomAnchor.constraint(equalTo: self.bottomAnchor),
    ...
    // todas minhas responsabilidades precisam ser enviadas para nossa viewController,
